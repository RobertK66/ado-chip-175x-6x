...
// Week callback for a "LPCOpen C Project" generated by MCUXpresso.
// The LPC17xx/40xx Base library provided a function which initialized the Chip to use the internal oscillator (IRC)
